...
\cvtext{
\cvlist{
    \item Software development (C, Rust, Nix, Python, Javascript, Zig)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% HEADER
\begin{minipage}{1\mpwidth}
    \begin {center}
        \HUGE{ \textbf{ \textcolor{black}{ \uppercase{ LUCAS ELISEI } } } } \\[12pt]
        \large{ \textcolor{black} {Senior Firmware Engineer} } \\[4pt]
        \textcolor{black}{ \rule{0.1\textwidth}{1.25pt} } \\[4pt]
        \textcolor{black}{C expert • Open to Rust development} \\
    \end {center}
\end{minipage} \\
...
\cvtext{
    Analytical and solution-oriented engineer with strong interdisciplinary collaboration skills.
    Expertise in embedded systems, real-time firmware development, and safety-critical architectures.
    Proven ability to lead technical initiatives and deliver robust solutions in regulated environments.
    ...
    % Seeking new professional challenges to contribute technical leadership and firmware architecture expertise to
    % dynamic projects.
}
...
\cvevent
    ...
    {\cvtext{\cvlist{
        \item Responsible of and developed safety-critical firmware modules
